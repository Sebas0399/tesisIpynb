...
class SplitData:
    def __init__(self):
        ...
        self.image_size = config.get("dataset","image_size")
    ...
    def split(self):
        if not os.path.exists('Nuevo'):
            ...
            for class_name in classes:
                ...
                val_images, test_images = train_test_split(temp_images, test_size=(self.val_size*2), random_state=42)  # 20% para val y 20% para test
